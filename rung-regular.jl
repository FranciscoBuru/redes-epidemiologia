...
plt = scatter(xx,yy,arrerb,dpi=300, title="beta-r-variation SIS-Regular", xlabel="beta", ylabel="r", zlabel="Infection probability", leg=false, xlims=(0,1), ylims=(0,1), zlims=(0,1))
